#define DebugDisplayUpdate 1

// Change to your WiFi credentials
const char* ssid     = "MY_SSID";     // WiFi SSID to connect to
const char* password = "MY_PASSWORD"; // WiFi password needed for the SSID

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "myopenweathermapkey";                      // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
const char server[] = "api.openweathermap.org";
//Set your location according to OWM locations

String City             = "myKaff";                        // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "CH";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
